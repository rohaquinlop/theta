//! Integration tests for theta-ai providers.
//!
...
//! Run with:
//! ```bash
//! OPENAI_API_KEY=sk-... cargo test -p theta-ai --features integration-tests
//! DEEPSEEK_API_KEY=sk-... cargo test -p theta-ai --features integration-tests
//! ```
//!
...
mod integration {
    ...
    fn test_model_openai() -> Model {
        use theta_ai::model::ModelCompat;
        Model {
