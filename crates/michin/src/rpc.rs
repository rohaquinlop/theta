...
pub async fn run_rpc(config: &MichiNConfig, working_dir: &Path) -> anyhow::Result<()> {
...
fn provider_to_string(provider: michin_ai::Provider) -> &'static str {
    match provider {
        michin_ai::Provider::OpenAI => "openai",
        michin_ai::Provider::OpenAiCodex => "openai-codex",
        michin_ai::Provider::DeepSeek => "deepseek",
        michin_ai::Provider::OpenCode | michin_ai::Provider::OpenCodeGo => "opencode",
        michin_ai::Provider::XiaomiMiMo => "xiaomi",
    }
}
